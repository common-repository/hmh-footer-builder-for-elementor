		...
		public function options_fields(){
			...
			foreach ($fields as $key => $field) {
				...
				if(in_array($field['type'], $allow)) {
					...
					esc_html_e('Type-field is not exists', 'hmh-footer-builder-for-elementor');
				}
			}
		...
		public function end_form_html(){
			?>
					...
					<button type="submit" name="submit" class="button success">
						...
						<?php echo (!empty($this->button_text))?$this->button_text:esc_html__('Save Changes', 'hmh-footer-builder-for-elementor') ?>
					</button>
				</form>
			</div>
			<?php
